...
public class Questions {
	...
	public int[] listGen() {
		...
		int[] listGen = new int[5];       
	    //Generates Random Numbers in between 100 and 200
	    for(int i = 0; i < listGen.length; i++) {
	    	listGen[i] =100+ (int)(Math.random()*51 + 1 / 2) * 2;
	    }//end for loop
	    System.out.println("Numbers Generated: " + Arrays.toString(listGen));
